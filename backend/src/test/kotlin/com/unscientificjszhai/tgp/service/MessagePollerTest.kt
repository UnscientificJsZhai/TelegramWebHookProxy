...
class MessagePollerTest {
     ...
     */
    private suspend fun MessagePoller.enqueueUpdateForTesting(update: Update) {
        val session = currentSessionOrNull(this) ?: return
        ...
        policy.enqueueUpdate(session, update)
    }
